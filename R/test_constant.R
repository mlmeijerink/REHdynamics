#' test_constant
#' 
#' Results for the test with K = 2-10 for time-varying network effects for 
#' the 200 generated datasets in the constant effects scenario. 
#' 
#' @format A list with 200 elements, each element a list of length 9, i.e.
#' one entry for eacah K = 2:10. These nine elements contain again a list of
#' length 3 with the following elements:
#' \describe{
